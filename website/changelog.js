...
(function () {
    ...
    fetch('changelog.md', { cache: 'no-cache' })
      ...
      .catch(function () {
        body.innerHTML = '<p>' + esc(document.getElementById('changelog-error').textContent) +
          ' <a href="https://github.com/pepperonas/beatbyte/blob/main/CHANGELOG.md" target="_blank" rel="noopener noreferrer">GitHub</a></p>';
      })
  ...
  document.getElementById('changelog-open').addEventListener('click', function () {
    if (typeof dialog.showModal !== 'function') {
      window.open('https://github.com/pepperonas/beatbyte/blob/main/CHANGELOG.md', '_blank', 'noopener');
      return;
    }
    dialog.showModal();
    load();
