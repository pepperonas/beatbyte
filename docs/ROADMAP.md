...
- [ ] A4 **Difficulty curve review.** Check Easy→Expert of the demo chart reads as a curve (density, chords, HOPO runs); adjust `DifficultyProfile` if not. dep: A1. *Verify: note-count/density table in findings; generation tests updated.*
