...
| `BEATBYTE_SHOT_VIEW` | view name | With `BEATBYTE_SHOT_STATE=stats`, opens that view (overview/timing/technique/difficulty/progress/songs/versus/insights) before shooting. Without it only the first of the eight could ever be photographed. |
