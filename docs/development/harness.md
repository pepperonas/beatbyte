...
| `BEATBYTE_AUTOPILOT_RATE` | `1`…`5` | Results-feedback drill: presses the real digit key (and RIGHT when the chart has a parent version), then parses the session log back and verifies the feedback lines landed. |
