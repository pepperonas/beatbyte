...
[![Tests](https://img.shields.io/badge/tests-517%20passing-brightgreen)](#testing)
...
[![Harnesses](https://img.shields.io/badge/harness%20switches-24-success)](docs/development/harness.md)
...
| `beatbyte-game` | 233 | UI kit contracts, settings persistence, the input tables and binding labels, the color language, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
