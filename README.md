...
[![Tests](https://img.shields.io/badge/tests-468%20passing-brightgreen)](#testing)
...
```bash
cargo test --workspace          # 468 tests
```
...
| `beatbyte-game` | 184 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
