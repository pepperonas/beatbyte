...
[![Tests](https://img.shields.io/badge/tests-451%20passing-brightgreen)](#testing)
...
[![Harnesses](https://img.shields.io/badge/harness%20switches-21-success)](docs/development/harness.md)
...
| `beatbyte-game` | 176 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
