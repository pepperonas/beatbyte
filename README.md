...
[![Tests](https://img.shields.io/badge/tests-492%20passing-brightgreen)](#testing)
...
```bash
cargo test --workspace          # 492 tests
```
...
| `beatbyte-game` | 208 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
