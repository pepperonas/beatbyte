...
[![Tests](https://img.shields.io/badge/tests-467%20passing-brightgreen)](#testing)
...
| `beatbyte-game` | 183 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
