...
[![Tests](https://img.shields.io/badge/tests-566%20passing-brightgreen)](#testing)
...
| `beatbyte-game` | 265 | UI kit contracts, settings persistence, the input tables and binding labels, the color language, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
