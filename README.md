...
[![Tests](https://img.shields.io/badge/tests-458%20passing-brightgreen)](#testing)
...
[![Harnesses](https://img.shields.io/badge/harness%20switches-22-success)](docs/development/harness.md)
...
| Crate | Tests | Covers |
|---|---:|---|
| `beatbyte-core` | 79 | Timing windows to their exact boundaries, judgment, scoring, combos, HOPO and tap rules, the hype meter, the telemetry schema |
...
| `beatbyte-game` | 177 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
