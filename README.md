...
[![Tests](https://img.shields.io/badge/tests-497%20passing-brightgreen)](#testing)
...
| `beatbyte-game` | 213 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
