...
[![Tests](https://img.shields.io/badge/tests-934%20passing-brightgreen)](#testing)
...
```bash
cargo test --workspace          # 934 tests
```
...
imported with a warning that also shows in the song browser.
