...
[![Tests](https://img.shields.io/badge/tests-1335%20passing-brightgreen)](#testing)
...
[![Harnesses](https://img.shields.io/badge/harness%20switches-37-success)](docs/development/harness.md)
...
```bash
cargo test --workspace          # 1335 tests
```
...
| `beatbyte-cli` | 19 | The play-history export (CSV quoting, UTC stamps, report filters), review analytics, the design dossier and the redesign rollout: section windowing, evidence thresholds, hash binding, the mastery veto, write instructions, carried difficulties, and the currency check comparing what a reader would get rather than what the generator produced |
