...
[![Tests](https://img.shields.io/badge/tests-1021%20passing-brightgreen)](#testing)
...
- 👾 **Two looks, one stage** — an 8-bit pixel identity and a smooth
  ...
  venue with real spotlights and shadows, full PA stacks, an LED wall
  and a crowd of people dancing to the song across six themes; every
  asset generated or openly licensed
...
```bash
cargo test --workspace          # 1021 tests
```
