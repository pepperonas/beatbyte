...
```bash
cargo test --workspace          # 488 tests
```
...
| `beatbyte-game` | 204 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
