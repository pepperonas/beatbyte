...
[![Tests](https://img.shields.io/badge/tests-888%20passing-brightgreen)](#testing)
...
[![ADRs](https://img.shields.io/badge/decisions-13%20ADRs-lightgrey)](docs/decisions/README.md)
...
```bash
cargo test --workspace          # 888 tests
```
...
| `beatbyte-cli` | 22 | The play-history export (CSV quoting, UTC stamps, report filters), review analytics, the design dossier and the redesign rollout: section windowing, evidence thresholds, hash binding, the mastery veto, write instructions, carried difficulties, and the currency check comparing what a reader would get rather than what the generator produced |
