...
[![Tests](https://img.shields.io/badge/tests-444%20passing-brightgreen)](#testing)
...
[![Harnesses](https://img.shields.io/badge/harness%20switches-20-success)](docs/development/harness.md)
...
| `beatbyte-game` | 171 | UI kit contracts, settings persistence, library scanning, import naming, the X-plorer report decoder, texture geometry, the song ribbon, list scrolling |
...
| `beatbyte-cli` | 18 | Review analytics, the design dossier and the redesign rollout: section windowing, evidence thresholds, hash binding, the mastery veto, write instructions, carried difficulties |
